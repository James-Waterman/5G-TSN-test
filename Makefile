...
#  opp_makemake -f --deep -O out -KINET_PROJ=../inet4.5 -KSIMU5G_PROJ=../simu5G -DINET_IMPORT -I. -I$$\(INET_PROJ\)/src -I$$\(SIMU5G_PROJ\)/src -L$$\(INET_PROJ\)/src -L$$\(SIMU5G_PROJ\)/src -lINET$$\(D\) -lsimu5g$$\(D\)
#
